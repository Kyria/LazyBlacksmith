...
# character endpoints
get_characters = esiapp.get_v5_swagger.op['get_characters_character_id']
get_characters_skills = esiapp.get_v4_swagger.op['get_characters_character_id_skills']
get_characters_blueprints = esiapp.get_v3_swagger.op['get_characters_character_id_blueprints']

# corporation related endpoints
get_characters_roles = esiapp.get_v3_swagger.op['get_characters_character_id_roles']
get_corporations_blueprints = esiapp.get_v3_swagger.op['get_corporations_corporation_id_blueprints']
